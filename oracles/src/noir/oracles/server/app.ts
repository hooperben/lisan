...
const jsonRPCServer: TypedJSONRPCServer<JSONRPCServerMethods, ServerParams> =
  new JSONRPCServer();
jsonRPCServer.addMethod(
  "get_header",
  getRpcOracleHandler.bind(this, getHeaderOracle)
);
jsonRPCServer.addMethod(
  "get_account",
  getRpcOracleHandler.bind(this, getAccountOracle)
);
jsonRPCServer.addMethod(
  "get_proof",
  getRpcOracleHandler.bind(this, getProofOracle)
);
jsonRPCServer.addMethod(
  "get_receipt",
  getRpcOracleHandler.bind(this, getReceiptOracle)
);
jsonRPCServer.addMethod(
  "get_transaction",
  getRpcOracleHandler.bind(this, getTransactionOracle)
);
jsonRPCServer.addMethod(
  "get_storage_recursive",
  getOracleHandler.bind(this, getStorageOracle)
);
